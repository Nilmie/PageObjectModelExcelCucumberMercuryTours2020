...
//
	 ...
	 /*   public void clickLogin(){
	   ...
	   public void setUserName(String firstName,String lastName,	String phone,String	userName,String	address1,
	   	String	city,String	state,String	postalCode,String	email,String	password,String	confirmPassword)
	    ...
	    //	driver.findElement(countryMurcury).sendKeys(country);
...
//String	country,
	      ...
	      this.setUserName(firstName, lastName,phone,userName,address1,city,state,postalCode,email,password,confirmPassword);
