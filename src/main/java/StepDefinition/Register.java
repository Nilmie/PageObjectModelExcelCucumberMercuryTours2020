...
public class Register {
	...
	//	String loginPageTitle = objLogin.getLoginTitle();
	    objLogin.RegisterUser(excel.readExcel(1,1, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,2, ".\\Data\\data.xlsx","Sheet1"),excel.readExcel(1,3, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,4, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,5, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,6, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,7, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,8, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,10, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,11, ".\\Data\\data.xlsx","Sheet1"), excel.readExcel(1,12, ".\\Data\\data.xlsx","Sheet1"));
	    //excel.readExcel(1,9, ".\\Data\\data.xlsx","Sheet1"),
